...
public class SkuInfoController {
    ...
    @GetMapping("{spuId}")
    public Resp<List<SkuInfoEntity>> getSkuInfoBySpuId(@PathVariable("spuId") Long spuId) {
        return Resp.ok(this.skuInfoService.list(new QueryWrapper<SkuInfoEntity>().eq("spu_id", spuId)));
    }
