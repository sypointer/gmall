...
public class WareSkuController {
    ...
    @GetMapping("{skuId}")
    public Resp<List<WareSkuEntity>> getWareInfoBySkuId(@PathVariable("skuId") Long skuId) {
        return Resp.ok(this.wareSkuService.list(new QueryWrapper<WareSkuEntity>().eq("sku_id", skuId)));
    }
